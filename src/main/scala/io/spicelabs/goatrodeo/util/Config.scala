...
object Config {
  ...
  /** Parse an expiry cutoff from its textual form: epoch milliseconds, an
    * ISO-8601 instant, or a flexible date string. Kept separate from
    * [[expiryFromProperty]] so the parsing rules can be tested without mutating
    * the process-global system property.
    */
